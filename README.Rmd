...
First, we specify the **telemetry site** we want data for. We can then select one of the **parameters** from the reference table created above. Lastly, enter a **date range** and the **temporal resolution** for the desired data ("day", "hour", or "raw").
