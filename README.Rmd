...
First, we specify the telemetry site **(abbrev = "CLAFTCCO")** we want data for. We can then select one of the **parameters** found in the **telemetry_params** reference table created above to specify which parameter we want to retrieve **(DISCHRG)**. Lastly, enter a **date range** and the **temporal resolution** of the desired data ("day", "hour", or "raw").
