...
We can use the functions in the table below to identify different types of stations/structures/wells within a given spatial extent, water district, division, county, designated basin, management district. Station data can also be retrieved by providing the specific abbreviation, GNIS ID, USGS ID, WDID, or Well ID for the structure of interest. 
...
```{r tele_stations_mask, eval=F, echo=TRUE}
...
We can use the functions in the table below retrieve timeseries data from the various timeseries related CDSS API endpoint. 
